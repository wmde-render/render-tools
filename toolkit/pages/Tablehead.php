...
<head>
	...
	<meta name="description" content="RENDER Toolkit for knowledge diversity in Wikipedia">
...
<?php if ($lang == "en"): ?>
<div id="Language">
	<a href="<?php echo $pathtoself; ?>?lang=de">
		<small>Deutsch: </small>
		<img src="/<?php echo $tsAccount;?>/toolkit/img/128px-Flag_of_Germany_(3-2_aspect_ratio).svg.png" border="0" width="24px"  alt="">
	</a>
</div>
<div id="Headline">
	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="80">
				<a href="http://wikimedia.de/wiki/Hauptseite" target="_blank">
					<img src="/<?php echo $tsAccount; ?>/toolkit/img/180px-Wikimedia_Deutschland_Logo.png" width="60px" border="0" alt="" />
				</a>
			</td>
			<td width="95%">
				<h1>RENDER Toolkit for Knowledge Diversity in Wikipedia</h1>
			</td>
			<td width="80">
				<a href="http://render-project.eu/" target="_blank">
					<img src="/<?php echo $tsAccount; ?>/toolkit/img/Logo_trans.PNG" width="60px" border="0" alt="">
				</a>
			</td>
		</tr>
	</table>
...
<div id="Rahmen">
	<ul id="Navigation">
		<li id="First">
			<a href="/<?php echo $tsAccount; ?>/toolkit/LEA/">LEA</a>
		</li>
	    <li>
			<a href="/<?php echo $tsAccount; ?>/toolkit/ChangeDetector/">Change Detector</a>
		</li>
		<li>
			<a href="/<?php echo $tsAccount; ?>/toolkit/WikiMap/">Wikipedia Map</a>
			<ul>
				<li>
					<a href="/<?php echo $tsAccount; ?>/toolkit/WikiMap/info.php">Description</a>
				</li>
			</ul>
		</li>
		<li>
			<a href="/<?php echo $tsAccount; ?>/toolkit/Corpex/">Corpex</a>
			<ul>
				<li>
					<a href="/<?php echo $tsAccount; ?>/toolkit/Corpex/info.php">Description</a>
				</li>
			</ul>
		</li> 
	</ul>
		...
		<tr>
			<td id="links">
				...
				<div id="Seite">
					<ul id="Navigation">
						<li>
							<a href="/<?php echo $tsAccount; ?>/toolkit/index.php">Home</a>
						</li>
						<li>
							<a href="/<?php echo $tsAccount; ?>/toolkit/pages/About.php">Info</a>
						</li>
						<li>
							<a href="/<?php echo $tsAccount; ?>/toolkit/downloads">Downloads</a>
						</li>
						<li>
							<a style="cursor: pointer;" onclick="javascript:openFeedbackDialog();">Feedback</a>
						</li>
					</ul>
				</div>
			</td>
...
<?php elseif( $lang == "de" ): ?>
<div id="Language">
	<a href="<?php echo $pathtoself; ?>?lang=en">
		<small>Englisch: </small>
		<img src="/<?php echo $tsAccount; ?>/toolkit/img/128px-Flag_of_the_United_Kingdom.svg.png" border="0" width="24px" alt="">
	</a>
</div>
...
<div id="Headline">	
	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="95%">
				<h1>RENDER Toolkit f&uuml;r Diversität in Wikipedia</h1>
			</td>
			<td width="80">
				<a href="http://render-project.eu/" target="_blank">
					<img src="/<?php echo $tsAccount; ?>/toolkit/img/Logo_trans.PNG" width="60px" border="0" alt="">
...
<div id="Rahmen">
	<ul id="Navigation">
		...
		<li>
			...
			<ul>
				<li>
					<a href="/<?php echo $tsAccount; ?>/toolkit/WikiMap/info.php">Erklärung</a>
				</li>
			</ul>
		</li>
		<li>
			...
			<ul>
				<li>
					<a href="/<?php echo $tsAccount; ?>/toolkit/Corpex/info.php">Erklärung</a>
				</li>
			</ul>
		</li> 
	</ul>
		...
		<tr>
			<td id="links">
				...
				<div id="Seite">
					<ul id="Navigation">
						<li>
							<a href="/<?php echo $tsAccount; ?>/toolkit/index.php">Start</a>
						</li>
						<li>
							<a href="/<?php echo $tsAccount; ?>/toolkit/pages/About.php">Info</a>
						</li>
